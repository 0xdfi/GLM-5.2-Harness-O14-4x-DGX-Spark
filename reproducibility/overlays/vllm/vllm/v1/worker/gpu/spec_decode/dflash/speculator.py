...
class DFlashSpeculator(DraftModelSpeculator):
    ...
    def propose(
        ...
        # [max_num_reqs]
        seeds: torch.Tensor,
        # Accepted for signature compatibility with the shared V2 call site.
        # DFlash drafts a whole block in one pass and has no per-step loop to
        # shorten, so R8 does not act on the selected depth here.
